...
public class FirstTests {
    ...
    public void setup() {
        ...
        System.out.println("wykonuje się tutaj!");
    ...
    private void highlightElement(WebElement sideBarVideo) {
    }
    ...
    public void SearchTesting(){
        driver.get("https://dev.to");
        AtomicReference<WebElement> Search;
        driver.findElement(By.cssSelector("#header-search > form > input.crayons-header--search-input.crayons-textfield")).sendKeys("Testing");
        wait = new WebDriverWait(driver, 10);
        driver.findElement(By.cssSelector("#header-search > form > input.crayons-header--search-input.crayons-textfield")).click();
